...
echo "  4. Apply the Netlify security headers block (docs/HOSTING-HEADERS.md netlify.toml section)."
echo "     If you host somewhere other than Netlify, update the provider named in privacy.html sections 3.3 and 6.1."
echo "  5. Uncomment the Sitemap line in site/robots.txt."
echo "  6. Set the editor env vars in Netlify (EDIT_PASSWORD, EDIT_SECRET,"
echo "     GITHUB_TOKEN, GITHUB_REPO) — see docs/EDITING.md. Without them the"
echo "     owner gets 'Editing is not configured on this deploy'."
